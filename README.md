...
- Release assets: `https://github.com/JongHyunLee84/daro-ios-binary/releases/download/1.1.49/<XCFRAMEWORK>.zip`
...
4. Create tag `1.1.49` and upload `artifacts/1.1.49/*.zip` as release assets.
